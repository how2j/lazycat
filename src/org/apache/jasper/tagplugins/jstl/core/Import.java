...
public class Import implements TagPlugin {
	...
	public void doTag(TagPluginContext ctxt) {
		...
		if (hasVarReader) {
			...
			ctxt.generateJavaSource("        " + tempReaderName + " = new java.io.InputStreamReader(" + inputStreamName
					+ ", " + charSetName + ");");
			...
			// close the reader
			ctxt.generateJavaSource("java.io.Reader " + tempReaderName2 + " = (java.io.Reader)pageContext.getAttribute("
					+ varReaderName + ");");
