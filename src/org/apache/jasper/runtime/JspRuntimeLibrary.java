...
public class JspRuntimeLibrary {
	...
	protected static void releaseTag(Tag tag, InstanceManager instanceManager) {
		try {
			...
			log.warn("Error processing release on tag instance of " + tag.getClass().getName(), t);
		}
		try {
			...
			ExceptionUtils.handleThrowable(t);
			log.warn("Error processing preDestroy on tag instance of " + tag.getClass().getName(), t);
		}
