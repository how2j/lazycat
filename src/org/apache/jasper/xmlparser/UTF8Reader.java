...
public class UTF8Reader extends Reader {
	...
	private void expectedByte(int position, int count) throws UTFDataFormatException {
		...
		throw new UTFDataFormatException(Localizer.getMessage("jsp.error.xml.expectedByte", Integer.toString(position),
	...
	private void invalidByte(int position, int count) throws UTFDataFormatException {
		...
		throw new UTFDataFormatException(
				Localizer.getMessage("jsp.error.xml.invalidByte", Integer.toString(position), Integer.toString(count)));
	}
	...
	private void invalidSurrogate(int uuuuu) throws UTFDataFormatException {
		...
		throw new UTFDataFormatException(
				Localizer.getMessage("jsp.error.xml.invalidHighSurrogate", Integer.toHexString(uuuuu)));
	}
