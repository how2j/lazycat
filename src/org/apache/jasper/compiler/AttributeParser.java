...
public class AttributeParser {
	...
	private static final boolean STRICT_QUOTE_ESCAPING = Boolean
			.parseBoolean(System.getProperty("org.apache.jasper.compiler.Parser.STRICT_QUOTE_ESCAPING", "true"));
	 ...
	 *            Should the rules of JSP.1.6 for escaping in attributes be
	 *            applied to EL in attribute values?
	...
	public static String getUnquoted(String input, char quote, boolean isELIgnored,
			boolean isDeferredSyntaxAllowedAsLiteral, boolean quoteAttributeEL) {
		return (new AttributeParser(input, quote, isELIgnored, isDeferredSyntaxAllowedAsLiteral, STRICT_QUOTE_ESCAPING,
	 ...
	 *         ambiguity.
	 */
	protected static String getUnquoted(String input, char quote, boolean isELIgnored,
	...
	private char nextChar() {
		...
		if (ch == '&') {
			if (i + 5 < size && input.charAt(i + 1) == 'a' && input.charAt(i + 2) == 'p' && input.charAt(i + 3) == 'o'
