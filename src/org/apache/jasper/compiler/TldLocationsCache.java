 ...
 * <taglib> elements in web.xml: the uri and location of the tag-library are
 * specified in the <taglib> element. 2. Via packaged jar files that contain
 * .tld files within the META-INF directory, or some subdirectory of it. The
 * taglib is 'global' if it has the <uri> element defined.
 *
