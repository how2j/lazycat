...
class Parser implements TagConstants {
	 ...
	 * The constructor
	 */
	private Parser(ParserController pc, JspReader reader, boolean isTagFile, boolean directivesOnly,
	...
	public static Node.Nodes parse(ParserController pc, JspReader reader, Node parent, boolean isTagFile,
			boolean directivesOnly, JarResource jarResource, String pageEnc, String jspConfigPageEnc,
	...
	private String parseAttributeValue(String watch, boolean ignoreEL) throws JasperException {
		...
		try {
			...
			ret = AttributeParser.getUnquoted(reader.getText(start, stop), quote, isElIgnored,
					pageInfo.isDeferredSyntaxAllowedAsLiteral(), quoteAttributeEL);
		} catch (IllegalArgumentException iae) {
