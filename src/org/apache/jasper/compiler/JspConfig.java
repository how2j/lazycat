...
public class JspConfig {
			...
			while (jspPropertyList.hasNext()) {
				...
				for (int p = 0; p < urlPatterns.size(); p++) {
					...
					JspProperty property = new JspProperty(isXml, elIgnored, scriptingInvalid, pageEncoding,
							includePrelude, includeCoda, deferredSyntaxAllowedAsLiteral, trimDirectiveWhitespaces,
	...
	public JspProperty findJspProperty(String uri) throws JasperException {
		...
		if (errorOnUndeclaredNamespaceMatch != null) {
			errorOnUndeclaredNamespace = errorOnUndeclaredNamespaceMatch.getJspProperty()
	...
	public static class JspProperty {
		...
		public JspProperty(String isXml, String elIgnored, String scriptingInvalid, String pageEncoding,
				Vector<String> includePrelude, Vector<String> includeCoda, String deferedSyntaxAllowedAsLiteral,
