...
class ParserController implements TagConstants {
	 ...
	 */
	public Node.Nodes parse(String inFileName, Node parent, JarResource jarResource)
	 ...
	 */
	public Node.Nodes parseTagFileDirectives(String inFileName, JarResource jarResource)
			throws FileNotFoundException, JasperException, IOException {
	 ...
	 *            filesystem
	 */
	private Node.Nodes doParse(String inFileName, Node parent, JarResource jarResource)
			throws FileNotFoundException, JasperException, IOException {
		...
		if (parent != null) {
			...
			if (jarFile == null) {
				...
				compiler.getPageInfo().addDependant(jarResource.getEntry(entry).toString(),
		...
		if (isXml) {
			...
			// JspDocumentParser.
			parsedPage = JspDocumentParser.parse(this, absFileName, jarFile, parent, isTagFile, directiveOnly,
					sourceEnc, jspConfigPageEnc, isEncodingSpecifiedInProlog, isBomPresent);
		} else {
			// Standard syntax
			...
			try {
				...
				parsedPage = Parser.parse(this, jspReader, parent, isTagFile, directiveOnly, jarResource, sourceEnc,
	 ...
	 */
	private void determineSyntaxAndEncoding(String absFileName, JarFile jarFile, String jspConfigPageEnc)
