 ...
 * This implementation retains smaller items in memory, while writing larger
 * ones to disk. The threshold between these two is configurable, as is the
 * location of files that are written to disk.
 * </p>
 * <p>
