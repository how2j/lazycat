...
public final class CookieSupport {
	...
	/**
	 * If set to true, the cookie header will be preserved. In most cases except
	 * debugging, this is not useful.
	 */
	...
	static {
		STRICT_SERVLET_COMPLIANCE = Boolean
				.parseBoolean(System.getProperty("org.apache.catalina.STRICT_SERVLET_COMPLIANCE", "false"));
		...
		String preserveCookieHeader = System
				.getProperty("org.apache.tomcat.util.http.ServerCookie.PRESERVE_COOKIE_HEADER");
		...
		ALLOW_NAME_ONLY = Boolean
				.parseBoolean(System.getProperty("org.apache.tomcat.util.http.ServerCookie.ALLOW_NAME_ONLY", "false"));
