...
public final class Const {
	...
	/**
	 * Marks a constant pool entry as a Module Reference. Note: Early access
	 * Java 9 support- currently subject to change.
	 * 
	 * @see <a href=
	...
	/**
	 * Marks a constant pool entry as a Package Reference. Note: Early access
	 * Java 9 support- currently subject to change.
	 * 
	 * @see <a href=
	 *      "http://cr.openjdk.java.net/~mr/jigsaw/spec/lang-vm.html#jigsaw-2.6">
	...
	private static final String[] CONSTANT_NAMES = { "", "CONSTANT_Utf8", "", "CONSTANT_Integer", "CONSTANT_Float",
			...
			"CONSTANT_MethodHandle", "CONSTANT_MethodType", "", "CONSTANT_InvokeDynamic", "CONSTANT_Module",
			"CONSTANT_Package" };
