...
public final class ClassParser {
	...
	private Annotations runtimeVisibleAnnotations; // "RuntimeVisibleAnnotations"
	 ...
	 * @throws IOException
	 *             If an I/O occurs reading the byte code
	...
	public JavaClass parse() throws IOException, ClassFormatException {
		...
		return new JavaClass(class_name, superclass_name, access_flags, constant_pool, interface_names,
