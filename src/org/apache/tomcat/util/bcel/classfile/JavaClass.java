 ...
 * <a href="http://docs.oracle.com/javase/specs/">JVM specification</a> for
...
public class JavaClass {
	...
	private final Annotations runtimeVisibleAnnotations; // "RuntimeVisibleAnnotations"
															// attribute defined
															// in the class
	 ...
	 * @param runtimeVisibleAnnotations
	 *            "RuntimeVisibleAnnotations" attribute defined on the Class, or
	 *            null
	 */
	JavaClass(final String class_name, final String superclass_name, final int access_flags,
			final ConstantPool constant_pool, final String[] interface_names,
