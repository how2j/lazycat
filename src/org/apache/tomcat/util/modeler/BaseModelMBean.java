...
public class BaseModelMBean implements DynamicMBean, MBeanRegistration, ModelMBeanNotificationBroadcaster {
	...
	public Object invoke(String name, Object params[], String signature[]) throws MBeanException, ReflectionException {
		...
		// Validate the input parameters
		if (name == null)
			throw new RuntimeOperationsException(new IllegalArgumentException("Method name is null"),
					"Method name is null");
	 ...
	 * registry. </strike> The caller can provide the mbean instance or the
	 * object name to the resource, if needed.
	 *
	 * @param resource
