...
public class MbeansDescriptorsIntrospectionSource extends ModelerSource {
	...
	private static Class<?>[] supportedTypes = new Class[] { Boolean.class, Boolean.TYPE, Byte.class, Byte.TYPE,
			Character.class, Character.TYPE, Short.class, Short.TYPE, Integer.class, Integer.TYPE, Long.class,
			Long.TYPE, Float.class, Float.TYPE, Double.class, Double.TYPE, String.class, strArray.getClass(),
			BigDecimal.class, BigInteger.class, ObjectName.class, objNameArray.getClass(), java.io.File.class, };
	...
	public ManagedBean createManagedBean(Registry registry, String domain, Class<?> realClass, String type) {
		...
		try {
			 ...
			 * pi.setName("param" + j); pi.setDescription(
			 * "Introspected parameter param" + j); info.addParameter(pi); }
