...
/**
 * <p>
 * Interface for use with {@link FactoryCreateRule}. The rule calls
 * {@link #createObject} to create an object to be pushed onto the
 * <code>Digester</code> stack whenever it is matched.
 * </p>
 *
 * <p>
 * {@link AbstractObjectCreationFactory} is an abstract implementation suitable
 * for creating anonymous <code>ObjectCreationFactory</code> implementations.
 */
