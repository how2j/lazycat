 ...
 * Concrete implementations should list all of their actual rule creation logic
 * in the <code>addRuleSet()</code> implementation.
 * </p>
 */
...
public abstract class RuleSetBase implements RuleSet {
	...
	/**
	 * The namespace URI that all Rule instances created by this RuleSet will be
	 * associated with.
	 */
