...
public class WsServerContainer extends WsWebSocketContainer implements ServerContainer {
	...
	public void addEndpoint(Class<?> pojo) throws DeploymentException {
		...
		sec = ServerEndpointConfig.Builder.create(pojo, path).decoders(Arrays.asList(annotation.decoders()))
				.encoders(Arrays.asList(annotation.encoders())).subprotocols(Arrays.asList(annotation.subprotocols()))
	...
	public void destroy() {
		...
		if (!success) {
			log.warn(sm.getString("serverContainer.threadGroupNotDestroyed", threadGroup.getName(),
	 ...
	 * @param response
	 *            The response object to be populated with the result of the
	 *            upgrade
	 * @param sec
	 ...
	 *             If a configuration error prevents the upgrade from taking
	 *             place
	 * @throws IOException
