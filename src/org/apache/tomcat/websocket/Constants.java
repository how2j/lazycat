...
public class Constants {
	...
	/*
	 * Configuration for extensions Note: These options are primarily present to
	 * enable this implementation to pass compliance tests. They are expected to
	 * be removed once the WebSocket API includes a mechanism for adding custom
	...
	static final boolean STREAMS_DROP_EMPTY_MESSAGES = Boolean
			.getBoolean("org.apache.tomcat.websocket.STREAMS_DROP_EMPTY_MESSAGES");
