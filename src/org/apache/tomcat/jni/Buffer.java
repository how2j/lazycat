...
public class Buffer {
	 ...
	 * Allocated memory must be provided from call to the Stdlib.alloc or
	 * Stdlib.calloc methods.
	 * 
	 * @param mem
	 *            The memory to use
	 * @param size
	 ...
	 * <b>Warning :</b> Call this method only on ByteBuffers that were created
	 * by calling Buffer.alloc or Buffer.calloc.
	 * 
	 * @param buf
