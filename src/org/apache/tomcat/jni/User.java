...
public class User {
	...
	/**
	 * Get the userid (and groupid) of the calling process This function is
	 * available only if APR_HAS_USER is defined.
	 * 
	 * @param p
	...
	/**
	 * Get the groupid of the calling process This function is available only if
	 * APR_HAS_USER is defined.
	 * 
	 * @param p
	 *            The pool from which to allocate working space
	...
	/**
	 * Get the userid for the specified username This function is available only
	 * if APR_HAS_USER is defined.
	 * 
	 * @param username
	...
	/**
	 * Get the groupid for the specified username This function is available
	 * only if APR_HAS_USER is defined.
	 * 
	 * @param username
	 *            The username to lookup
	 * @param p
	...
	/**
	 * Get the groupid for a specified group name This function is available
	 * only if APR_HAS_USER is defined.
	 * 
	 * @param groupname
	...
	/**
	 * Get the user name for a specified userid This function is available only
	 * if APR_HAS_USER is defined.
	 * 
	 * @param userid
	 *            The userid
	...
	/**
	 * Get the group name for a specified groupid This function is available
	 * only if APR_HAS_USER is defined.
	 * 
	 * @param groupid
	 *            The groupid
	...
	/**
	 * Compare two user identifiers for equality. This function is available
	 * only if APR_HAS_USER is defined.
	 * 
	 * @param left
	 *            One uid to test
	...
	/**
	 * Compare two group identifiers for equality. This function is available
	 * only if APR_HAS_USER is defined.
	 * 
	 * @param left
	 *            One gid to test
	...
	/**
	 * Get the home directory for the named user This function is available only
	 * if APR_HAS_USER is defined.
	 * 
	 * @param username
	 *            The named user
