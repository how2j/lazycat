...
public abstract class AuthenticatorBase extends ValveBase implements Authenticator {
	 ...
	 */
	private static final String DATE_ONE = (new SimpleDateFormat(DateTool.HTTP_RESPONSE_DATE_HEADER, Locale.US))
			.format(new Date(1));
	 ...
	 */
	@Override
	public abstract boolean authenticate(Request request, HttpServletResponse response, LoginConfig config)
			throws IOException;
