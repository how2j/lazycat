...
public class SpnegoAuthenticator extends AuthenticatorBase {
	...
	/**
	 * This class implements a hack around an incompatibility between the SPNEGO
	 * implementation in Windows and the SPNEGO implementation in Java 8 update
	 * 40 onwards. It was introduced by the change to fix this bug:
	 * https://bugs.openjdk.java.net/browse/JDK-8048194 (note: the change
	 * applied is not the one suggested in the bug report)
	 * <p>
