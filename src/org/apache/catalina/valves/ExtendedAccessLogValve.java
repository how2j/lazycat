...
public class ExtendedAccessLogValve extends AccessLogValve {
	 ...
	 *         and the value will be wrapped in quotes and any quotes will be
	 *         escaped with 2 sets of quotes.
	 */
		...
		if ("date".equals(token)) {
			...
			if ("ip".equals(nextToken)) {
				...
				return new AccessLogElement() {
					@Override
					public void addElement(StringBuilder buf, Date date, Request request, Response response,
							long time) {
						String value;
						try {
