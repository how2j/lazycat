 ...
 * header instead of denying the request. This can be combined with the context
 * attribute <code>preemptiveAuthentication="true"</code> and an authenticator
 * to force authentication instead of denial.
 * <p>
...
public abstract class RequestFilterValve extends ValveBase {
	 ...
	 * header to trigger basic auth instead of denying the request..
	 */
