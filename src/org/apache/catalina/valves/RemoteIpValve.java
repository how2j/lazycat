 ...
 * when the <code>protocolHeader</code> indicates <code>http</code> protocol
 * </td>
 * <td>N/A</td>
 * <td>integer</td>
 * <td>80</td>
 ...
 * <td>Value returned by {@link javax.servlet.ServletRequest#getServerPort()}
 * when the <code>protocolHeader</code> indicates <code>https</code> protocol
 * </td>
 * <td>N/A</td>
 * <td>integer</td>
 * <td>443</td>
		...
		if (internalProxies != null && internalProxies.matcher(originalRemoteAddr).matches()) {
			...
			if (log.isDebugEnabled()) {
				log.debug("Incoming request " + request.getRequestURI() + " with originalRemoteAddr '"
						...
						+ originalSecure + "', originalScheme='" + originalScheme + "' will be seen as newRemoteAddr='"
						+ request.getRemoteAddr() + "', newRemoteHost='" + request.getRemoteHost() + "', newScheme='"
