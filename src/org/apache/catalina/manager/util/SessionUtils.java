...
public class SessionUtils {
	 ...
	 */
	private static final String[] LOCALE_TEST_ATTRIBUTES = new String[] { STRUTS_LOCALE_KEY, SPRING_LOCALE_KEY,
			JSTL_LOCALE_KEY, "Locale", "java.util.Locale" };
	/**
	 ...
	 */
	private static final String[] USER_TEST_ATTRIBUTES = new String[] { "Login", "User", "userName", "UserName",
	...
	public static Object guessUserFromSession(final Session in_session) {
		...
		try {
			...
			// If there is only one, consider it to be /the/ user
			{
				...
				for (Enumeration<String> enumeration = httpSession.getAttributeNames(); enumeration
						.hasMoreElements();) {
					String name = enumeration.nextElement();
