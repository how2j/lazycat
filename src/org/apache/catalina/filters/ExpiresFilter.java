...
/**
 * <p>
 * ExpiresFilter is a Java Servlet API port of
 * <a href="http://httpd.apache.org/docs/2.2/mod/mod_expires.html">Apache
 * mod_expires</a> to add '{@code Expires}' and '{@code Cache-Control: max-age=}
 * ' headers to HTTP response according to its '{@code Content-Type}'.
 * </p>
 * 
 * <p>
 * Following documentation is inspired by
 * <a href="http://httpd.apache.org/docs/2.2/mod/mod_expires.html">mod_expires
 * </a>
 * </p>
 * <h1>Summary</h1>
 * <p>
 * This filter controls the setting of the {@code Expires} HTTP header and the
 * {@code max-age} directive of the {@code Cache-Control} HTTP header in server
 * responses. The expiration date can set to be relative to either the time the
 * source file was last modified, or to the time of the client access.
 * </p>
 * <p>
 ...
 * 2616 section 14.9</a>), you can use other servlet filters or
 * <a href="http://httpd.apache.org/docs/2.2/mod/mod_headers.html" >Apache Httpd
 * mod_headers</a> module.
 * </p>
 * <h1>Filter Configuration</h1>
 * <h2>Basic configuration to add '{@code Expires}' and '
 * {@code Cache-Control: max-age=}' headers to images, css and javascript</h2>
 *
 * <pre>
 * {@code
 * <web-app ...>
 ...
 * </pre></code>
 * <p>
 * Sample of per-request log message where {@code ExpiresFilter} does not add an
 * expiration date
 * </p>
 * 
 * <code><pre>
...
public class ExpiresFilter extends FilterBase {
	 ...
	 * to the slow {@link #getHeader(String)} and to spare the {@code string} to
	 * {@code date} to {@code long} conversion.
	 * </p>
	 */
	...
	/**
	 * Return {@code true} if the given {@code str} is {@code null} or has a
	 * zero characters length.
	 */
	...
	/**
	 * Return {@code true} if the given {@code str} has at least one character
	 * (can be a withespace).
	 */
	...
	/**
	 * Return {@code true} if the given {@code string} starts with the given
	 * {@code prefix} ignoring case.
	 * 
	 * @param string
	 *            can be {@code null}
	 * @param prefix
	 ...
	 * occurence of the given {@code separator}. Return {@code null} if the
	 * given {@code str} or the given {@code separator} is null. Return and
	 * empty string if the {@code separator} is empty.
	 * 
	 * @param str
	 *            can be {@code null}
	 * @param separator
	 ...
	 * {@code null} if no expiration date has been configured for the declared
	 * content type.
	 * </p>
	 * <p>
	 ...
	 * {@link HttpServletResponse#getContentType()} costs {@code String} objects
	 * instantiations (as of Tomcat 7).
	 * </p>
	 */
