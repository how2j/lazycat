...
public class MBeanUtils {
	 ...
	 */
	private static String exceptions[][] = { { "org.apache.catalina.users.MemoryGroup", "Group" },
	...
	static ObjectName createObjectName(String domain, Context context) throws MalformedObjectNameException {
		...
		name = new ObjectName(domain + ":j2eeType=WebModule,name=//" + host.getName() + cn.getDisplayName()
	...
	public static ObjectName createObjectName(String domain, ContextEnvironment environment)
		...
		if (container instanceof Server) {
			...
			name = new ObjectName(domain + ":type=Environment" + ",resourcetype=Context,context=" + cn.getDisplayName()
					+ ",host=" + host.getName() + ",name=" + environment.getName());
		}
		return (name);
	...
	public static ObjectName createObjectName(String domain, ContextResource resource)
		...
		if (container instanceof Server) {
			...
			ContextName cn = new ContextName(context.getName(), false);
			Container host = context.getParent();
			name = new ObjectName(domain + ":type=Resource" + ",resourcetype=Context,context=" + cn.getDisplayName()
					+ ",host=" + host.getName() + ",class=" + resource.getType() + ",name=" + quotedResourceName);
		}
	...
	public static ObjectName createObjectName(String domain, ContextResourceLink resourceLink)
		...
		if (container instanceof Server) {
			...
			ContextName cn = new ContextName(context.getName(), false);
			Container host = context.getParent();
			name = new ObjectName(domain + ":type=ResourceLink" + ",resourcetype=Context,context=" + cn.getDisplayName()
					+ ",host=" + host.getName() + ",name=" + quotedResourceLinkName);
		}
	...
	static ObjectName createObjectName(String domain, Group group) throws MalformedObjectNameException {
		...
		ObjectName name = null;
		name = new ObjectName(domain + ":type=Group,groupname=" + ObjectName.quote(group.getGroupname()) + ",database="
	...
	static ObjectName createObjectName(String domain, NamingResources resources) throws MalformedObjectNameException {
		...
		if (container instanceof Server) {
			...
			ContextName cn = new ContextName(context.getName(), false);
			Container host = context.getParent();
			name = new ObjectName(domain + ":type=NamingResources" + ",resourcetype=Context,context="
