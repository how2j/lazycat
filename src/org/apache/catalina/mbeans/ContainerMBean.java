...
public class ContainerMBean extends BaseModelMBean {
	 ...
	 * supported. Won't start the child yet. Has to be started with a call to
	 * Start method after necessary configurations are done.
	 * 
	 * @param type
	 *            ClassName of the child to be added
	 * @param name
	 ...
	 *
	 * @param type
	 *            The ClassName of the listeners to be removed. Note that all
	 *            the listeners having given ClassName will be removed.
	 */
