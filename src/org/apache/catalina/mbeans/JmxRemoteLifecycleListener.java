...
public class JmxRemoteLifecycleListener implements LifecycleListener {
	...
	public void lifecycleEvent(LifecycleEvent event) {
		...
		if (Lifecycle.START_EVENT.equals(event.getType())) {
			...
			csPlatform = createServer("Platform", rmiBindAddress, rmiRegistryPortPlatform, rmiServerPortPlatform, env,
	...
	private JMXConnectorServer createServer(String serverName, String bindAddress, int theRmiRegistryPort,
			int theRmiServerPort, HashMap<String, Object> theEnv, RMIClientSocketFactory registryCsf,
			RMIServerSocketFactory registrySsf, RMIClientSocketFactory serverCsf, RMIServerSocketFactory serverSsf) {
		...
		try {
			...
			log.error(sm.getString("jmxRemoteLifecycleListener.createRegistryFailed", serverName,
		...
		try {
			...
			log.info(sm.getString("jmxRemoteLifecycleListener.start", Integer.toString(theRmiRegistryPort),
	...
	public static class SslRmiServerBindSocketFactory extends SslRMIServerSocketFactory {
		...
		public SslRmiServerBindSocketFactory(String[] enabledCipherSuites, String[] enabledProtocols,
				boolean needClientAuth, String address) {
