...
public interface Context extends Container {
	 ...
	 * have a common session ID across multiple web applications. Therefore, any
	 * client provided session ID should already exist in another web
	 ...
	 * {@link #setValidateClientProvidedNewSessionId(boolean)}) before use?
	 *
	 ...
	 * trailing slash) by the Mapper. This is more efficient but has the side
	 * effect of confirming that the directory is valid.
	 *
	 ...
	 *
	 * @param useRelativeRedirects
	 *            {@code true} to use relative redirects and {@code false} to
	 *            use absolute redirects
	 */
	 ...
	 *
	 * @param dispatchersUseEncodedPaths
	 *            {@code true} to use encoded paths, otherwise {@code false}
	 */
