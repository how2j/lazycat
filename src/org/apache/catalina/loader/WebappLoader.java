...
public class WebappLoader extends LifecycleMBeanBase implements Loader, PropertyChangeListener {
	 ...
	 * class should extend WebappClassLoaderBase, otherwise, a different loader
	...
	protected void startInternal() throws LifecycleException {
		...
		try {
			...
			if (container instanceof StandardContext) {
				...
				classLoader
						.setClearReferencesStopThreads(((StandardContext) container).getClearReferencesStopThreads());
