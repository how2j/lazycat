...
public class JKStatusUpdateTask extends AbstractCatalinaTask {
	 ...
	 * <ul>
	 * <li><b>load balance example: </b>
	 * http://localhost/status?cmd=update&mime=txt&w=lb&lf=false&ls=true</li>
	 * <li><b>worker example: </b>
	 * http://localhost/status?cmd=update&mime=txt&w=node1&l=lb&wf=1&wd=false&ws
	 * =false</li>
	 * </ul>
	 * 
