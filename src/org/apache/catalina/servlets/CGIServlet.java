 ...
 * work-in-progress &amp; expired Internet Draft. Note no actual RFC describing
 * the CGI specification exists. Where the behavior of this servlet differs from
 * the specification cited above, it is either documented here, a bug, or an
 ...
 * <a href="http://tomcat.apache.org/lists.html">Tomcat group</a> with
 * amendments.
 *
 * </p>
 * <p>
 ...
 * init parameter <code>stderrTimeout</code> of your webapps' cgi-handling
 * servlet.
 * </p>
 * <p>
 *
...
public final class CGIServlet extends HttpServlet {
	...
	private Pattern envHttpHeadersPattern = Pattern
			.compile("ACCEPT[-0-9A-Z]*|CACHE-CONTROL|COOKIE|HOST|IF-[-0-9A-Z]*|REFERER|USER-AGENT");
	...
	public void init(ServletConfig config) throws ServletException {
		...
		boolean passShellEnvironment = Boolean
				.parseBoolean(getServletConfig().getInitParameter("passShellEnvironment"));
