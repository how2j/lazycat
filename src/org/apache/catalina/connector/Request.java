...
public class Request implements HttpServletRequest {
	...
	static boolean isSSLAttribute(String name) {
		return Globals.CERTIFICATES_ATTR.equals(name) || Globals.CIPHER_SUITE_ATTR.equals(name)
				|| Globals.KEY_SIZE_ATTR.equals(name) || Globals.SSL_SESSION_ID_ATTR.equals(name)
				|| Globals.SSL_SESSION_ID_TOMCAT_ATTR.equals(name) || Globals.SSL_SESSION_MGR_ATTR.equals(name);
	}
	...
	protected Session doGetSession(boolean create) {
		...
		if ((session != null) && (getContext() != null) && getContext().getServletContext()
