...
/**
 * Abstract implementation of the {@link Store} interface to support most of the
 * functionality required by a {@link Store}.
 *
 * @author Bip Thelin
 */
public abstract class StoreBase extends LifecycleBase implements Store {
	 ...
	 *
	 * @param listener
	 *            a value of type {@link PropertyChangeListener}
	 */
	@Override
