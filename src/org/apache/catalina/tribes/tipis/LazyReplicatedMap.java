 ...
 * methods:<br>
 * <code>replicate(boolean)</code> and <code>replicate(Object, boolean)</code>
 * <br>
 ...
 * ReplicatedMapEntry interface, and return true when isDiffable() is invoked.
 * <br>
 * <br>
 * 
...
public class LazyReplicatedMap<K, V> extends AbstractReplicatedMap<K, V> {
	...
	public LazyReplicatedMap(MapOwner owner, Channel channel, long timeout, String mapContextName, ClassLoader[] cls) {
		super(owner, channel, timeout, mapContextName, AbstractReplicatedMap.DEFAULT_INITIAL_CAPACITY,
				AbstractReplicatedMap.DEFAULT_LOAD_FACTOR, Channel.SEND_OPTIONS_DEFAULT, cls, true);
	}
	...
	protected Member[] publishEntryInfo(Object key, Object value) throws ChannelException {
		...
		do {
			...
			try {
				...
				log.error("Unable to replicate backup key:" + key + " to backup:" + next + ". Reason:" + x.getMessage(),
						x);
				continue;
			}
			try {
				...
				// the others
				// should still get it.
				log.error("Unable to replicate proxy key:" + key + " to backup:" + next + ". Reason:" + x.getMessage(),
						x);
			}
