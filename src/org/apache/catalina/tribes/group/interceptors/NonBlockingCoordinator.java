 ...
 * A-src, mbrs-A,B,C,D,E} to B When A receives X again, the token is complete.
 * <br>
...
public class NonBlockingCoordinator extends ChannelInterceptorBase {
	 ...
	 */
	protected static final byte[] COORD_HEADER = new byte[] { -86, 38, -34, -29, -98, 90, 65, 63, -81, -122, -6, -110,
			99, -54, 13, 63 };
	/**
	 * Coordination request
	 */
	protected static final byte[] COORD_REQUEST = new byte[] { 104, -95, -92, -42, 114, -36, 71, -19, -79, 20, 122, 101,
			-1, -48, -49, 30 };
	/**
	 * Coordination confirmation, for blocking installations
	 */
	protected static final byte[] COORD_CONF = new byte[] { 67, 88, 107, -86, 69, 23, 76, -70, -91, -23, -87, -25, -125,
			86, 75, 20 };
		...
		synchronized (electionMutex) {
			...
			if (local.equals(leader) || force) {
				...
				if (suggestedviewId == null && (!coordMsgReceived.get())) {
					...
					// CoordinationEvent(CoordinationEvent.EVT_WAIT_FOR_MSG,this,"Election,
					// waiting timed out."));
					// startElection(true);
					fireInterceptorEvent(new CoordinationEvent(CoordinationEvent.EVT_ELECT_ABANDONED, this,
	...
	protected boolean alive(Member mbr) {
		return TcpFailureDetector.memberAlive(mbr, COORD_ALIVE, false, false, waitForCoordMsgTimeout,
				waitForCoordMsgTimeout, getOptionFlag());
	}
	...
	public static class CoordinationEvent implements InterceptorEvent {
		...
		public String toString() {
			...
			buf.append(Arrays.toNameString(suggestedView != null ? suggestedView.getMembers() : null))
					.append("\n\tMembers:");
