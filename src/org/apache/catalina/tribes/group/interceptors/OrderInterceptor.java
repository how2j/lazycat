 ...
 * OrderInterceptor.expire=<milliseconds> - if a message arrives out of order,
 * how long before we act on it <b>default=3000ms</b><br>
 * OrderInterceptor.maxQueue=<max queue size> - how much can the queue grow to
 * ensure ordering. This setting is useful to avoid OutOfMemoryErrors
