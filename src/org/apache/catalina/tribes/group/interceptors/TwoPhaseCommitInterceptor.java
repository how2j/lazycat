...
public class TwoPhaseCommitInterceptor extends ChannelInterceptorBase {
	...
	private static final byte[] START_DATA = new byte[] { 113, 1, -58, 2, -34, -60, 75, -78, -101, -12, 32, -29, 32,
			111, -40, 4 };
	private static final byte[] END_DATA = new byte[] { 54, -13, 90, 110, 47, -31, 75, -24, -81, -29, 36, 52, -58, 77,
			-110, 56 };
	...
	public void messageReceived(ChannelMessage msg) {
		if (okToProcess(msg.getOptions())) {
			if (msg.getMessage().getLength() == (START_DATA.length + msg.getUniqueId().length + END_DATA.length)
				...
				UniqueId id = new UniqueId(msg.getMessage().getBytesDirect(), START_DATA.length,
