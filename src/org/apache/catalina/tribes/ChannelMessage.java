 ...
 * serialized in the Channel object and then passed down to the interceptor and
 * eventually down to the ChannelSender component
 * 
 * @author Filip Hanik
 * 
 */
public interface ChannelMessage extends Serializable {
	 ...
	 * <code>Channel.getLocalMember(boolean)</code><br>
	 * This would be set to a different address if the message was being relayed
	 * from a host other than the one that originally sent it.
	 * 
	...
	/**
	 * Each message must have a globally unique Id. interceptors heavily depend
	 * on this id for message processing
	 * 
	 * @return byte
	 */
