 ...
 * <code>accept(Serializable, Member)</code> if it doesn't intend to process the
 * message. The channel can this way track whether a message was processed by an
 * above application or if it was just received and forgot about, a feature
 * required to support message-response(RPC) calls<br>
 * 
 * @author Filip Hanik
 * @version 1.0
 */
