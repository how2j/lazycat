 ...
 * is sent as a byte array<br>
 * By default Tribes uses java serialization when it receives an object to be
 * sent over the wire. Java serialization is not the most efficient of
 * serializing data, and Tribes might not even have access to the correct class
 * loaders to deserialize the object properly. <br>
 ...
 * <code>getMessage()</code> bytes.<br>
 * If you are using multiple applications on top of Tribes you should add some
 * sort of header so that you can decide with the
 * <code>ChannelListener.accept()</code> whether this message was intended for
 * you.
 * 
 * @author Filip Hanik
 */
