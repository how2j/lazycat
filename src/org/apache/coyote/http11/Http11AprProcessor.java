...
public class Http11AprProcessor extends AbstractHttp11Processor<Long> {
	...
	protected boolean prepareSendfile(OutputFilter[] outputFilters) {
		...
		if (fileName != null) {
			...
			sendfileData.start = ((Long) request.getAttribute(org.apache.coyote.Constants.SENDFILE_FILE_START_ATTR))
					.longValue();
			sendfileData.end = ((Long) request.getAttribute(org.apache.coyote.Constants.SENDFILE_FILE_END_ATTR))
					.longValue();
			return true;
		}
		return false;
