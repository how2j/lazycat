...
public class Http11AprProtocol extends AbstractHttp11Protocol<Long> {
	...
	protected static class Http11ConnectionHandler extends AbstractConnectionHandler<Long, Http11AprProcessor>
			implements Handler {
		 ...
		 */
		@Override
		public void release(SocketWrapper<Long> socket, Processor<Long> processor, boolean isSocketClosing,
				boolean addToPoller) {
		...
		protected Http11AprProcessor createProcessor() {
			Http11AprProcessor processor = new Http11AprProcessor(proto.getMaxHttpHeaderSize(),
					(AprEndpoint) proto.endpoint, proto.getMaxTrailerSize(), proto.getAllowedTrailerHeadersAsSet(),
		...
		protected Processor<Long> createUpgradeProcessor(SocketWrapper<Long> socket,
			...
			return new AprProcessor(socket, httpUpgradeProcessor, (AprEndpoint) proto.endpoint,
