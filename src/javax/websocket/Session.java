...
public interface Session extends Closeable {
	 ...
	 * 
	 * @param timeout
	 *            The new idle timeout for this session in milliseconds. Zero or
	 ...
	 *
	 * @throws IOException
	 *             if an I/O error occurs while the WebSocket session is being
	 *             closed.
	 */
	@Override
	 ...
	 *
	 * @param <T>
	 *            The type of message that the given handler is intended for
	 * @param clazz
