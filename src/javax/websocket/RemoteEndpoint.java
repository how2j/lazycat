...
public interface RemoteEndpoint {
	...
	interface Async extends RemoteEndpoint {
		 ...
		 * 
		 * @param timeout
		 *            The new timeout for sending messages asynchronously in
		 *            milliseconds. A non-positive value means an infinite
		 *            timeout.
		 */
		 ...
		 *            sent
		 * @throws IllegalArgumentException
		 *             if {@code data} or {@code completion} is {@code null}.
		 */
		 ...
		 *            sent
		 * @throws IllegalArgumentException
		 *             if {@code obj} or {@code completion} is {@code null}.
		 */
	...
	interface Basic extends RemoteEndpoint {
		 ...
		 *             if there was a problem encoding the {@code data} object
