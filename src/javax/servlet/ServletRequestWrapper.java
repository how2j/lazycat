...
public class ServletRequestWrapper implements ServletRequest {
	 ...
	 *             If asynchronous processing is not supported for this request
	 *             or if the request is already in asynchronous mode
	 * @since Servlet 3.0
	 */
	@Override
	 ...
	 *            The ServletRequest with which to initialise the asynchronous
	 *            context
	 * @param servletResponse
	 *            The ServletResponse with which to initialise the asynchronous
	 *            context
	 * @throws IllegalStateException
	 *             If asynchronous processing is not supported for this request
	 *             or if the request is already in asynchronous mode
	 ...
	 * 
	 * @param wrapped
	 *            The request to compare to the wrapped request
	 ...
	 * 
	 * @param wrappedType
	 *            The class to compare to the class of the wrapped request
	 * @return <code>true</code> if the request wrapped by this wrapper (or
