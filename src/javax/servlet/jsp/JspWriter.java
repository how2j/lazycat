...
public abstract class JspWriter extends java.io.Writer {
	 ...
	 * java.lang.String#valueOf(boolean)}</code> is written to the JspWriter's
	 * buffer or, if no buffer is used, directly to the underlying writer.
	 * 
	 * @param b
	 ...
	 * java.lang.String#valueOf(int)}</code> is written to the JspWriter's
	 * buffer or, if no buffer is used, directly to the underlying writer.
	 * 
	 * @param i
	 ...
	 * java.lang.String#valueOf(long)}</code> is written to the JspWriter's
	 * buffer or, if no buffer is used, directly to the underlying writer.
	 * 
	 * @param l
	 ...
	 * java.lang.String#valueOf(float)}</code> is written to the JspWriter's
	 * buffer or, if no buffer is used, directly to the underlying writer.
	 * 
	 * @param f
