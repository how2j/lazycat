...
public abstract class ELResolver {
	 ...
	 * @param base
	 *            The base object on which the property is to be found
	 * @param property
	 *            The property whose type is to be returned
	 ...
	 *            The EL context for this evaluation
	 * @param base
	 *            The base object on which the method is to be found
	 * @param method
	 *            The method to invoke
	 * @param paramTypes
	 *            The types of the parameters of the method to invoke
	 * @param params
